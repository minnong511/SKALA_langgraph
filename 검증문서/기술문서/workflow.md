...
조사에서 근거와 판단 확보 시 추가 검색 최대 1회, 새 원문이 없는 추가 검색은 즉시 중단.
출처 연결 보정은 새 검색 없이 기존 발췌로 최대 1회 수행, 확인 불가 정보는 한계로 기록.
조사 실행당 원문 최대 12개, 회차별 질문 최대 3개, 질문/도구당 성공 원문 읽기 최대 3개.
총 호출 기본 400회, 그중 후속 단계용 100회 보존. 300회 사용 이후 조사 호출 중단.
조사끼리 원문 캐시 공유, 근거 검증은 캐시를 우회하여 인용된 원문 독립 재확인.
